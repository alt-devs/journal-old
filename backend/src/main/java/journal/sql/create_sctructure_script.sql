...
create index idx_compserv_id_serv_cat on journal.company_service using BTREE (id_service_category);
...
create index idx_empserv_id_service on journal.employee_service using BTREE (id_service);
...
create index idx_empservcat_id_serv_cat on journal.employee_service_category using BTREE (id_service_category);
...
alter table journal.company_service
   add constraint fk_service_ref_servcat foreign key (id_service_category)
...
alter table journal.employee_service
   add constraint fk_empserv_ref_serv foreign key (id_service)
...
alter table journal.employee_service_category
   add constraint fk_empservcat_ref_servcat foreign key (id_service_category)
      references journal.company_service_category (id)
      on delete restrict on update restrict;
