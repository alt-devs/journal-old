...
//    @PostMapping("/signup")
    ...
    public ApiResponse registerUser(@GraphQLArgument(name = "credentialInput") CredentialInput credentialInput) {
        if (userRepository.existsByUsername(credentialInput.getUsername())) {
            return new ApiResponse(false, "Пользователь с указанным логином уже присутствует в системе!");
...
//        user.setRoles(Collections.singleton(userRole));
        ...
        return new ApiResponse(true, "Пользователь успешно зарегистрирован!");
    }
}